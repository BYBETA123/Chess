...
def main():
    ...
    while GameOver==0:
        ...
        PrintBoard()
        GetMove("W")
        checklist = inCheck("W").getAttacker()
        if len(checklist)!=0:
            GameDebug("Check")
            for item in checklist:
                ...
                if len(attackinglist)!=0:
                    ...
                    [king_x, king_y] = inCheck("W").getLocation()
                    ...
                    #empylist has dictionaries inside of it
